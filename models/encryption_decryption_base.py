...
class EncryptionBase(ABC):
    ...
    def perform_encryption(self, code: str) -> bool:
        ...
        print(f"{encryption_result_message} {encrypted_result.__message}")
        return encrypted_result.__is_passed

    def perform_decryption(self, code: str) -> bool:
        decrypted_result = self.decrypt(code)
        print(f"{decryption_result_message} {decrypted_result.__message}")
        return decrypted_result.__is_passed
